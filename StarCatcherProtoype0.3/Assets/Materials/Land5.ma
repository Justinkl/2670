...
//Name: Land5.ma
//Last modified: Sat, Oct 01, 2016 05:25:35 PM
//Codeset: 1252
requires maya "2017";
...
createNode transform -n "pCube5";
	rename -uid "D7FDD98C-4D80-021C-F5E5-D29AA9094453";
	setAttr ".t" -type "double3" 100 0 0 ;
	setAttr ".s" -type "double3" 25 10 4 ;
createNode mesh -n "pCubeShape5" -p "pCube5";
	rename -uid "DC6ED49A-416F-E5B1-E57F-42830BF07091";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	...
	setAttr -s 12 ".pt";
	setAttr ".pt[12]" -type "float3" 0 -0.17990935 0 ;
	setAttr ".pt[14]" -type "float3" 0.10029095 0.44737104 0 ;
	setAttr ".pt[17]" -type "float3" 0 -0.15092035 0 ;
	setAttr ".pt[19]" -type "float3" 0 -0.07069622 0 ;
	setAttr ".pt[20]" -type "float3" 0 -0.070213258 0 ;
	setAttr ".pt[23]" -type "float3" 0 -0.17990935 0 ;
	setAttr ".pt[25]" -type "float3" 0.10029095 0.44737104 0 ;
	setAttr ".pt[27]" -type "float3" 0 1.4901161e-008 0 ;
	setAttr ".pt[28]" -type "float3" 0 -0.15092035 0 ;
	setAttr ".pt[30]" -type "float3" 0 -0.07069622 0 ;
	setAttr ".pt[31]" -type "float3" 0 -0.070213258 0 ;
