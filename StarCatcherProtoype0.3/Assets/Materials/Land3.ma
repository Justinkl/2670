...
//Name: Land3.ma
//Last modified: Sat, Oct 01, 2016 05:21:16 PM
//Codeset: 1252
requires maya "2017";
...
createNode transform -n "pCube3";
	rename -uid "2D464EEE-407F-42AA-AEA0-739C4008E555";
	setAttr ".t" -type "double3" 50 0 0 ;
	setAttr ".s" -type "double3" 25 10 4 ;
createNode mesh -n "pCubeShape3" -p "pCube3";
	rename -uid "5554BBE6-4F9F-E006-A237-91B6D5482C17";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	...
	setAttr -s 14 ".pt";
	setAttr ".pt[13]" -type "float3" 0.014909419 0.39522153 0 ;
	setAttr ".pt[14]" -type "float3" 0 0.36613655 0 ;
	setAttr ".pt[15]" -type "float3" -0.033480812 0 0 ;
	setAttr ".pt[16]" -type "float3" 0 -0.13495164 0 ;
	setAttr ".pt[17]" -type "float3" 0 -0.047357779 0 ;
	setAttr ".pt[19]" -type "float3" 0 0.092417873 0 ;
	setAttr ".pt[20]" -type "float3" 0 0.17809531 0 ;
	setAttr ".pt[24]" -type "float3" 0.014909419 0.39522153 0 ;
	setAttr ".pt[25]" -type "float3" 0 0.36613655 0 ;
	setAttr ".pt[26]" -type "float3" -0.033480812 0 0 ;
	setAttr ".pt[27]" -type "float3" 0 -0.13495164 0 ;
	setAttr ".pt[28]" -type "float3" 0 -0.047357779 0 ;
	setAttr ".pt[30]" -type "float3" 0 0.092417873 0 ;
	setAttr ".pt[31]" -type "float3" 0 0.17809531 0 ;
