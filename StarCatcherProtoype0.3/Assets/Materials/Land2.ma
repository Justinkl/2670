...
//Name: Land2.ma
//Last modified: Sat, Oct 01, 2016 05:18:50 PM
//Codeset: 1252
requires maya "2017";
...
createNode transform -n "pCube2";
	rename -uid "A35E3EE7-403A-AE33-2ADE-288869D9DFC9";
createNode mesh -n "pCubeShape2" -p "pCube2";
	rename -uid "682D402E-41AF-5F7E-F8DE-CE9E8CE5C5B3";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	...
	setAttr -s 12 ".pt";
	setAttr ".pt[12]" -type "float3" 0.039633986 0.10457718 0 ;
	setAttr ".pt[14]" -type "float3" 0.039014649 0.27623397 0 ;
	setAttr ".pt[17]" -type "float3" 0 0.26447284 0 ;
	setAttr ".pt[18]" -type "float3" 0 0.18611404 0 ;
	setAttr ".pt[19]" -type "float3" 0 0.24604887 0 ;
	setAttr ".pt[23]" -type "float3" 0.039633986 0.10457718 0 ;
	setAttr ".pt[25]" -type "float3" 0.039014649 0.27623397 0 ;
	setAttr ".pt[28]" -type "float3" 0 0.26447284 0 ;
	setAttr ".pt[29]" -type "float3" 0 0.18611404 0 ;
	setAttr ".pt[30]" -type "float3" 0 0.24604887 0 ;
...
createNode animCurveTU -n "pCube2_visibility";
	rename -uid "1A286AD9-4968-54CF-39A0-7DBB79649B2A";
	setAttr ".tan" 9;
	setAttr ".ktv[0]"  1 1;
	setAttr ".kot[0]"  5;
createNode animCurveTL -n "pCube2_translateX";
	rename -uid "2D5C35F6-4FD4-FD3A-3DB5-BE923896FE3D";
	setAttr ".tan" 18;
	setAttr ".ktv[0]"  1 25;
createNode animCurveTL -n "pCube2_translateY";
	rename -uid "6D71487D-40FC-3520-8945-F3B80F711610";
	setAttr ".tan" 18;
	setAttr ".ktv[0]"  1 0;
createNode animCurveTL -n "pCube2_translateZ";
	rename -uid "ACE51505-425F-1916-4690-21B1423E56D8";
	setAttr ".tan" 18;
	setAttr ".ktv[0]"  1 0;
createNode animCurveTA -n "pCube2_rotateX";
	rename -uid "2BAC8A7E-43B3-5D48-3561-BC88B90AE044";
	setAttr ".tan" 18;
	setAttr ".ktv[0]"  1 0;
createNode animCurveTA -n "pCube2_rotateY";
	rename -uid "06556DEC-4691-02BC-E7F9-0683C7844E77";
	setAttr ".tan" 18;
	setAttr ".ktv[0]"  1 0;
createNode animCurveTA -n "pCube2_rotateZ";
	rename -uid "12A19159-480B-D70A-6AF7-569A4A8E598A";
	setAttr ".tan" 18;
	setAttr ".ktv[0]"  1 0;
createNode animCurveTU -n "pCube2_scaleX";
	rename -uid "A5181205-4130-1A0D-6DAD-0DA2751C6B55";
	setAttr ".tan" 18;
	setAttr ".ktv[0]"  1 25;
createNode animCurveTU -n "pCube2_scaleY";
	rename -uid "FC3E0C20-4B42-2D73-EAA1-9A880399B069";
	setAttr ".tan" 18;
	setAttr ".ktv[0]"  1 10;
createNode animCurveTU -n "pCube2_scaleZ";
	rename -uid "6CA816BC-4241-3D26-DCF2-45A0C4FBC62B";
	setAttr ".tan" 18;
	setAttr ".ktv[0]"  1 4;
select -ne :time1;
	setAttr ".o" 1;
